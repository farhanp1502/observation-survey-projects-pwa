...
export const environment: Environment = {
  ...
  projectsBaseURL: window['env' as any][
    'projectsBaseURL' as any
  ] as unknown as string,
  surveyBaseURL: window['env' as any][
    'surveyBaseURL' as any
  ] as unknown as string,
  ...
  unauthorizedRedirectUrl: window['env' as any][
    'unauthorizedRedirectUrl' as any
  ] as unknown as string,
  isAuthBypassed: window['env' as any][
    'isAuthBypassed' as any
  ] as unknown as any,
  config: window['env' as any]['config' as any] as unknown as any,
  profileRedirectPath: window['env' as any][
    'profileRedirectPath' as any
  ] as unknown as any,
  showHeader: window['env' as any]['showHeader' as any] as unknown as any,
  contentPolicyURL: window['env' as any][
    'contentPolicyURL' as any
  ] as unknown as any,
};
